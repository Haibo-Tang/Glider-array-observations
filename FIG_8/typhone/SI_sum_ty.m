...
for  i=1:length(text_lon)
    for j=1:length(text_lat)
        ...
        text(text_lon(i)-0.025,text_lat(j),num2str(eddy_numbe_SI(j,i)),'color','k','fontweight','bold','fontsize',10)
        end
    end
end
